...
from sources import repago_source, frescura_source, grupos_source, planificacion_source, ventas_actual_source, promotores_kpi_source, topes_repo_source
...
_SOURCES = (
    ...
    ("Topes Core / Value", topes_repo_source),
